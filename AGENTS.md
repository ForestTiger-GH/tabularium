...
7. Keep natively machine-readable source artifacts such as HTML, XLSX, CSV, XML, and JSON in their original format. Store PDF publications as complete source-faithful Markdown transcriptions.
